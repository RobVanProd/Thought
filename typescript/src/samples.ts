export const RAW_SPEC_OUTPUT = `Analyzing the feasibility of the /thought tagging system.
...
export const EXPECTED_SPEC_THOUGHTS = {
...
export const EXPECTED_SPEC_CLEAN_OUTPUT = `Analyzing the feasibility of the /thought tagging system.
